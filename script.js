...
function fillEmpIDEvening() {
  ...
  const url = `https://script.google.com/macros/s/AKfycbzCCNz8S-o_5df7SqnUBTT1R_QGbxdKTNpxxiqsvUEy1eSI7A_rehGIKoNtLtuWH-c/exec?username=${encodeURIComponent(user)}`;
...
function submitForm() {
  ...
  fetch("https://script.google.com/macros/s/AKfycbzCCNz8S-o_5df7SqnUBTT1R_QGbxdKTNpxxiqsvUEy1eSI7A_rehGIKoNtLtuWH-c/exec", {
    method: "POST",
    mode: "no-cors",
